...
class _SingleNetworkUserWidgetState extends State<SingleNetworkUserWidget> {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title:  Text("Username", maxLines: 1, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.bodyMedium,),
      subtitle:
          Text("20 mutual connections", maxLines: 2, overflow: TextOverflow.ellipsis,  style: Theme.of(context).textTheme.labelSmall,),
      ...
      trailing: Container(
        ...
        child: const Center(
          child: Text("Connect", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: oPrimaryColor),),
        ),
      ) ,
