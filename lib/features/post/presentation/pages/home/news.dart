...
import 'package:uni_link/features/post/presentation/pages/home/widget/news_widget.dart';
          ...
          child: BlocBuilder<PostCubit, PostState>(
            builder: (context, postState) {
              ...
              if (postState is PostLoaded) {
                return postState.post.where((post) => post.postType=="News").isEmpty
                    ? _noPostsYetWidget()
                    : ListView.builder(
                  itemCount: postState.post.where((post) => post.postType=="News").length,
                  itemBuilder: (context, index) {
                    final post = postState.post[index];
                    if(post.postType=='News'){
                    return BlocProvider(
                      create: (context) => di.sl<PostCubit>(),
                      child: NewsWidget(post: post),
