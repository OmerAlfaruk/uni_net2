...
import 'package:uni_link/features/app/global/dialog_widget.dart';
import 'package:uni_link/features/app/global/show_image_picked_widget.dart';
import 'package:uni_link/features/app/global/show_video_picked_widget.dart';
import 'package:uni_link/features/chat/domain/entities/message_entities.dart';
import 'package:uni_link/features/chat/domain/entities/message_replay_entities.dart';
import 'package:uni_link/features/chat/presentation/manager/cubit/message/message_cubit.dart';
import 'package:uni_link/features/chat/presentation/widgets/chat_util.dart';
import 'package:uni_link/features/chat/presentation/widgets/message_replay_preview_widget.dart';
...
late DownloadService downloadService;
  ...
  Widget build(BuildContext context) {
    ...
    bool dark=OHelperFunctions.isDark(context);
              ...
              BlocBuilder<GetSingleUserCubit, GetSingleUserState>(
                  builder: (context, state) {
                    if (state is GetSingleUserLoaded) {
                      return state.user.isOnline == true ? const Text(
                        "Online",
                            ...
                            itemBuilder: (context, index) {
                              ...
                              if(message.senderUid == widget.message.senderUid) {
                                return _messageLayout(
                                  ...
                                  onLongPress: () {
                                    ...
                                    displayAlertDialog(
                                        ...
                                        confirmTitle: "Delete",
                                        content: "Do you sure you want to delete this message?"
                                    );
                                  },
                                  onSwipe: () {
                                    onMessageSwipe(
                                ...
                                return _messageLayout(
                                  ...
                                  isSeen:  message.isSeen,
                                  isShowTick: false,
                                  messageBgColor: Colors.greenAccent,
                                  rightPadding: message.repliedMessage == "" ? 85 : 5,
                                  reply: MessageReplayEntity(
                                      message: message.repliedMessage,
                                      messageType: message.repliedMessageType,
                            ...
                            children: [
                              Expanded(
                                child: Container(
                                  ...
                                  child: TextField(
                                    ...
                                    style: TextStyle(color: dark?Colors.black:oPrimaryColor),
                                          ...
                                          children: [
                                            Transform.rotate(
                                              ...
                                              child: GestureDetector(
                                                onTap: () {
                                                  setState(() {
                                                    _isShowAttachWindow==true?_hideKeyboard():null;
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  width: 50,
                                  height: 50,
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), color: oPrimaryColor),
                                  child: Center(
                                    child: Icon(
                            ...
                            Row(
                              ...
                              children: [
                                _attachWindowItem(
                                  ...
                                  title: "Document",
                                    onTap: () {
                                      _pickDocument().then((value) {
                                        if (_selectedDocument != null) {

                                                _sendDocumentMessage(); // Assuming _sendDocumentMessage sends the selected document
  ...
  void _sendDocumentMessage() {
    StorageProviderRemoteDataSource.uploadMessageFile(
      ...
      uid: widget.message.senderUid,
      otherUid: widget.message.recipientUid,
      type: MessageTypeConst.documentMessage,
    ).then((documentUrl) {
      _sendMessage(message: documentUrl, type: MessageTypeConst.documentMessage);
    });
  }
  ...
  Future<void> _downloadMessage(BuildContext context, String message) async {
    if (downloadService != null) {
      try {
        await downloadService.downloadMessage(message);
        // Handle download success (e.g., show a toast message)
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Message downloaded successfully!'),
      ...
      print("Download service not available!"); // Handle missing service (optional)
    }
  }
